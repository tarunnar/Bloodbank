...
$res=mysql_query("insert into rhosloc (rid,city,state,homeloc) values ('$RID','$CITY','$STATE','$HOMELOC')");
  if($res)
        {
                echo "insert hua";
        }
