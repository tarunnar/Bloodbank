...
$res=mysql_query("insert into donorloc (did,city,state,homeloc) values ('$DID','$CITY','STATE','HOMELOC')");
  if($res)
        {
                echo "insert hua";
        }
